    ...
    <div className="container">
      ...
      <div className="row">
        ...
        <div className="col-md-12 mb-3">
          ...
          <div className="dinas-info col-md-12">
            <marquee onMouseOver={(e) => e.target.stop()} onMouseOut={(e) => e.target.start()}>
      ...
      <div className="row">
        <div className="col-md-8">
          <div className="jl_m_center_w jl_radus_e" style={{ position: "relative" }}>
            <div
              className="jl_f_img_bg"
              style={{ backgroundImage: `url(${beritaUtama.image})`, height: 360, backgroundSize: "cover" }}
            />
            ...
            <div className="text-box">
              ...
              <span className="post-date pl-2" style={{ color: "#305b90" }}>{beritaUtama.tanggal}</span>
      ...
      <div className="row mb-4">
        {ebookList.map((eb) => (
          <div className="col-md-6 mb-4" key={eb.id}>
            <div className="jl_topik_center_w jl_radus_e" style={{ position: "relative", height: 280 }}>
              <div className="jl_f_img_bg" style={{ backgroundImage: `url(${eb.thumb})`, height: "100%", backgroundSize: "cover" }} />
              <a href={eb.file} target="_blank" rel="noreferrer" className="jl_f_img_link" title="Baca Buku" />
              <div className="text-box">
                <span className="jl_f_cat"><a style={{ background: "#305b90" }} className="post-category-color-text">{eb.kategori}</a></span>
      ...
      <div className="row">
        ...
        <div className="col-md-4">
          ...
          <div className="card p-0 shadow-sm text-center">
